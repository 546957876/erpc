...
type SettingsForm = { logLevel: string; listenV4: boolean; httpHostV4: string; httpPortV4: number; listenV6: boolean; httpPortV6?: number; adminEnabled: boolean; statePollerInterval?: string };
...
export function SettingsPage() {
  ...
  function buildSettingsOverrides(values: SettingsForm): ConfigPayload {
    ...
    if (values.adminEnabled && !payload.admin) payload.admin = {};
